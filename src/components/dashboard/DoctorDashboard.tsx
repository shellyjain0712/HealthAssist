            ...
            <div className="flex items-center gap-4">
              ...
              >
                ...
                {appointments.filter(a => a.status === "pending").length > 0 && (
                  <span className="absolute -top-1 -right-1 min-w-5 h-5 bg-red-500 text-white text-xs font-bold rounded-full flex items-center justify-center shadow-lg animate-pulse">
